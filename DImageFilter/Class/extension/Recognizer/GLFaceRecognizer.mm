...
#import "GLFaceRecognizer.h"
#import "UIImage+OpenCV.h"

using namespace cv;

@interface GLFaceRecognizer () {
...
@implementation GLFaceRecognizer

+ (GLFaceRecognizer *)faceRecognizerWithFile:(NSString *)path {
    GLFaceRecognizer *fr = [GLFaceRecognizer new];
